...
package com.girosyfinanzas.schema.direccioncanales.persontype;
...
@XmlType(name = "PersonType", propOrder = { "id", "codTypeIdentification", "valNameType", "valFirstName",
		"valMiddleName", "valLastName", "valMiddleLastName", "valGender", "dateOfBirth", "age", "valBirthPlace",
		"valPhone", "valMobile", "valEmail", "valNationality", "valCountry", "valState", "valCity",
		"valCurrentLocationZIP", "valResidencePlace", "valAddress", "codState", "codMobileCountry", "valSMSFlag",
		"valEstratum", "countryName", "desCity", "phoneCityCode", "phoneCountryCode", "valMaritalStatus", "occupation",
		"ciiu" })
