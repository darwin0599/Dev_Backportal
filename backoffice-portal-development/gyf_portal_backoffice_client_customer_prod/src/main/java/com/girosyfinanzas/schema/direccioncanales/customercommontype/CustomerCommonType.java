...
package com.girosyfinanzas.schema.direccioncanales.customercommontype;
 ...
 *         &lt;element name="fecExpeditionId" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "CustomerCommonType", propOrder = { "typeCustomer", "id", "typeIdentification", "name1", "name2",
		"name3", "name4", "economicActivity", "levelEconomicActivity", "clientPEP", "fecLastUpdate", "lastUpdatedData",
		"nationality", "fecExpeditionId", "fecEnroll", "enrold" })
public class CustomerCommonType {
	...
	protected String fecExpeditionId;
	...
	/**
	 * Gets the value of the fecExpeditionId property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	public String getFecExpeditionId() {
		return fecExpeditionId;
	}

	/**
	 * Sets the value of the fecExpeditionId property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setFecExpeditionId(String value) {
		this.fecExpeditionId = value;
	}
