...
@XmlType(name = "ErrorType", namespace = "http://girosyfinanzas.com/schema/DireccionCanales/ErrorType/", propOrder = {
		"codError", "codTypeSeverity", "codTypeError", "descError", "notification" })
