...
@XmlType(name = "ContextTransactionType", namespace = "http://girosyfinanzas.com/schema/DireccionCanales/ContextTransactionType/", propOrder = {
		"idTx", "idUser", "idConsumer", "idService", "codTypeTx", "creationMsgDate" })
