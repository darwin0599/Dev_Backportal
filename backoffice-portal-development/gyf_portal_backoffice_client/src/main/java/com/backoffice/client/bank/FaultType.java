 ...
 *         &lt;element name="errors" type="{http://girosyfinanzas.com/schema/DireccionCanales/FaultType_v2/}ErrorsList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FaultType", namespace = "http://girosyfinanzas.com/schema/DireccionCanales/FaultType_v2/", propOrder = {
		"contextResponse", "errors" })
public class FaultType {
	 ...
	 * 
	 * @return possible object is {@link ErrorsList }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ErrorsList }
	 * 
	 */
